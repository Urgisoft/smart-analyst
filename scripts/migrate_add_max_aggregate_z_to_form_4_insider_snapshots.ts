 ...
 * columns to `quantlab.form_4_insider_snapshots`.
 *
 ...
 *
 * Usage:
 *   npm run migrate:add-max-z-form-4-insider-snapshots
...
export const help: HelpEntry[] = [
  {
    npm: 'migrate:add-max-z-form-4-insider-snapshots',
    category: 'Data quality',
    what:
      'Dry-run: show planned ADD COLUMN max_aggregate_z + max_aggregate_z_sector ' +
      'on quantlab.form_4_insider_snapshots (G2 Step 2 persistence wiring, ' +
      'OQ-G3-1 strategy β). No DDL executed.',
  },
  {
    npm: 'migrate:add-max-z-form-4-insider-snapshots:apply',
    category: 'Data quality',
    what:
